                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Container(
                                  height: 25.h,
                                  width: 130.w,
                                  color: const Color.fromARGB(55, 238, 171, 64),
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                fontSize: 12.sp,
                                fontWeight: FontWeight.w400,
                                color: const Color.fromARGB(110, 48, 48, 48),
                              ),
                            )
                          ],
                        ),
                        Positioned(
                          ...
                          child: InkWell(
                            ...
                            child: Obx(
                              () => Visibility(
                                visible: favController.isProductFavorite(index),
                                replacement: Icon(
                                  Icons.favorite_outline_outlined,
                                  size: 30.sp,
                                  color: const Color.fromARGB(76, 48, 48, 48),
                                ),
                                child: Icon(
                                  Icons.favorite,
                                  size: 30.sp,
